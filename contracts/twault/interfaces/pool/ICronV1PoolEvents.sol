...
interface ICronV1PoolEvents is ICronV1PoolEnums {
  ...
  ///         TODO: update to explain contents when LongTermExtend is join type
  ///
  event PoolJoin(
    address indexed sender,
  ...
  ///
  /// NOTE: Presented here for consistency (to aid users that a call to CronV1Pool might
  ///       trigger a ProtocolFeeTooLarge event to be emitted by the CronLibV1 library contract).
  ///       Event is actually emitted in CronLibV1 code and is duplicately defined there.
  ///
