...
interface ICronV1PoolEnums {
  ...
  ///           Daily:
  ///
  ///             - Intended for pools with inactivity, features maximum gas savings for inactivity during Long-Term
  ///               orders.
  ///             Short-Term Swap Fee  = 10 FP (0.010%)
  ///             Arbitrageur Swap Fee =  5 FP (0.005%)
  ///             Long-Term Swap Fee   = 30 FP (0.030%)
  ///             Order Block Interval = 7200 blocks (~ 24 hours)
  ///
  enum PoolType {
    Stable, // 0
    Liquid, // 1
  ...
  ///         - LongTermExtend extends an existing long-term swap at the existing sales rate and refunds any
  ///           difference.
  ///
  enum JoinType {
    Join, // 0
