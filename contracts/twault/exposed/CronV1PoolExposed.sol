...
contract CronV1PoolExposed is CronV1Pool {
  ...
  function getOrderInterval() public view returns (uint256) {
    return uint256(ORDER_BLOCK_INTERVAL);
  }

  function getMaxOrderIntervals() public view returns (uint256) {
    return uint256(MAX_ORDER_INTERVALS);
  }
}
