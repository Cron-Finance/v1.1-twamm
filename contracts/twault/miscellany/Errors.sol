...
library CronErrors {
  ...
  uint256 internal constant INVALID_OR_EXPIRED_ORDER = 229;
  uint256 internal constant INSUFFICIENT_AMOUNT = 230;
  uint256 internal constant PAUSED_ORDER = 231;
  uint256 internal constant ACTIVE_ORDER = 232;
  uint256 internal constant WRONG_ORDER_TOKEN_PROVIDED = 233;
