...
export function getCurrOrderId(): number
{
  return _orderId
}
...
export class Swap {
  ...
  isDirection0To1(): boolean {
    return this._direction0To1
  }
...
export class VaultTwammPoolAPIHelper {
  ...
  async getExtendObjects ( token0AmtScaled: BigNumber,
                           token1AmtScaled: BigNumber,
                           orderId: number): Promise<JoinObjects>
  {
    return this._getJoinRequest(JoinType.LongTermExtend,
                                token0AmtScaled,
                                token1AmtScaled,
                                undefined,
                                undefined,
                                 ...
                                 orderId?: number): Promise<any>
  {
    ...
    const _orderId = (orderId == undefined) ? BigNumber.from(0) : BigNumber.from(orderId)
    ...
    const userData: BytesLike = ethers.utils.defaultAbiCoder.encode(
      ...
      [joinType, amounts, minAmounts, _orderId]
    );
