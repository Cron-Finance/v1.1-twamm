...
const config: HardhatUserConfig = {
  ...
  docgen: {
    ...
    exclude: [
      "contracts/helpers",
      "contracts/mock",
      "contracts/twault/balancer-core-v2",
      "contracts/twault/exposed",
      "contracts/twault/helpers",
      "contracts/twault/interfaces/IERC20*",
      "contracts/twault/interfaces/IUni*",
      "contracts/twault/interfaces/ICronV1PoolExposed*",
      "contracts/twault/libraries",
      "contracts/twault/mev",
      "contracts/twault/partners",
      "contracts/twault/scripts",
      "contracts/twault/test",
    ],
    // only: [
    //   "^contracts/twault/CronV1Pool.sol",
    //   "^contracts/twault/factories/CronV1PoolFactory.sol",
    //   "^contracts/twault/interfaces/ICronV1Pool.sol",
    //   "^contracts/twault/interfaces/ICronV1PoolFactory.sol",
    //   "^contracts/twault/interfaces/IArbitrageurList.sol",
    // ],
  },
  abiExporter: [
    {
